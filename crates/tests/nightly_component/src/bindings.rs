...
pub trait IStaticClassStatics_Impl: Sized {
    fn Property(&self) -> ::windows::core::Result<i32>;
}
impl ::windows::core::RuntimeName for IStaticClassStatics {
    const NAME: &'static str = "test_nightly_component.IStaticClassStatics";
}
impl IStaticClassStatics_Vtbl {
    pub const fn new<Identity: ::windows::core::IUnknownImpl, Impl: IStaticClassStatics_Impl, const OFFSET: isize>() -> IStaticClassStatics_Vtbl {
        unsafe extern "system" fn Property<Identity: ::windows::core::IUnknownImpl, Impl: IStaticClassStatics_Impl, const OFFSET: isize>(this: *mut ::core::ffi::c_void, result__: *mut i32) -> ::windows::core::HRESULT {
            let this = (this as *mut ::windows::core::RawPtr).offset(OFFSET) as *mut Identity;
            let this = (*this).get_impl() as *mut Impl;
            match (*this).Property() {
                ::core::result::Result::Ok(ok__) => {
        ...
        Self { base__: ::windows::core::IInspectableVtbl::new::<Identity, IStaticClassStatics, OFFSET>(), Property: Property::<Identity, Impl, OFFSET> }
    }
    pub fn matches(iid: &windows::core::GUID) -> bool {
        iid == &<IStaticClassStatics as ::windows::core::Interface>::IID
    }
}
